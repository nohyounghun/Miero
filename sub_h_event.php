...
<head>
    ...
    <title>미에로화이바 서브페이지</title>
    <!-- css 초기화 -->
    <link rel="stylesheet" href="http://nnnyh93.dothome.co.kr/0311/css/reset.css" type="text/css">
    
    <!-- 기본서식 -->
    <link rel="stylesheet" href="http://nnnyh93.dothome.co.kr/0311/css/base.css" type="text/css">

    <!-- 공통서식 (상단헤더, 푸터서식) -->
    <link rel="stylesheet" href="http://nnnyh93.dothome.co.kr/0311/css/common.css" type="text/css">

    <!-- 서브페이지 서식 -->
    <link rel="stylesheet" href="http://nnnyh93.dothome.co.kr/0311/css/sub.css" type="text/css">
...
<body>
    ...
    <header>
        <h1>
            <a href="../../0311/index.html" title="메인페이지로 바로가기">
                <img src="http://nnnyh93.dothome.co.kr/0311/images/logo2.png" alt="상단로고">
            </a>
        </h1>
    ...
    <main>
        <section class="con">
            ...
            <nav>
                <ul>
                    <li><a href="../../0311/index.html" title="홈으로 가기">HOME</a></li>
                    <li>미에로 이벤트</li>
                    <li>진행중인 이벤트</li>
                </ul>
            </nav>
